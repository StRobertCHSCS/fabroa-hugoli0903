...
print("This is the text a print statement")
print("What's wrong with this statement?")
print("How about this one?")

print("There are 3 things in a variable: a name, a type and value")

Hello = "Goodbye"

print(Hello,"and thank you for the service provided")
print(3.14)
print(5)
